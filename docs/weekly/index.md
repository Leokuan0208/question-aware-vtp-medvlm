...
| [5](week-05/index.md)  | Jun 7 – Jun 13, 2026  | pivot | Single-model routing **closed** (correlated errors, −25 to −29σ), pivot to a **7B→32B cross-model cascade** — complementarity is real (+12.5pp oracle, 20–27% only-7B) and a **margin-gated cascade matches 32B at 30–60% cost** on competent benchmarks; accuracy headroom unreachable from cheap signals | <span class="pill pill--wip">In progress</span> |
